	...
	var docs = [
{
	 ...
	 description: "",
	 arguments: [],
	 example: '<kbd>// create instance of Factory</kbd>\n<var>factory</var> = Person_Factory()'+
	 '\n\n<kbd>// create Persons</kbd>\nfactory.create("male", datetime(1990, 3,17), 54, 154) <kbd>&ltMan instance 0x236467&gt</kbd>',
	 methods: [{
		 name: "get_age",
		 arguments: [{
			 name: 'date',
		 ...
		 equations: [],
		 example: '<kbd>// create instance of Factory</kbd>\n<var>factory</var> = Person_Factory()'+
		 '\n\n<kbd>// get age from a date</kbd>\nfactory.get_age(datetime(1990,3,17))<kbd>24.96</kbd>',
	 },
	 {
		 name: "create",
		 arguments: [
		 ...
		 example: '<kbd>// create instance of Factory</kbd>\n<var>factory</var> = Person_Factory()'+
		 '\n\n<kbd>// create Persons</kbd>\nfactory.create(Person_Factory("male", datetime(1990, 3,17), 54, 154)) <kbd>Man instance #&lt0x236467#&gt</kbd>',
	 }
	 ],
	},
	    {
		 name: "Person",
		 description: "As people are the focus of healthcare, they are focus of PyFit. The Person object is capable of performing all calculations that PyFit has to offer.",
		 arguments: [{
			 name: "gender",
			 units: "string",
		 },
		 ...
		 example: '<kbd>// create instance of Person</kbd>\n<var>var</var> me = Person("John Doe", "male", datetime.datetime(1990,3,17), 54, 154)'+
		 '\n\n<kbd>// call methods from Person</kbd>\nme.get_age() <kbd>24.96</kbd>'+
		 '\nme.cardio.get_age() <kbd>24.96</kbd>',
		 methods: [{
			 name: "get_age",
			 arguments: [],
			 val: "years",
			 ...
			 equations: [],
			 example: '<kbd>// create instance of Person</kbd>\n<var>var</var> me = Person("John Doe", "male", datetime.datetime(1990,3,17), 54, 154)'+
			 '\n\n<kbd>// call get_age from Person</kbd>\nme.get_age() <kbd>24.96</kbd>',
		 },
		 {
			 name: "bmiToBodyFat",
			 arguments: [],
		...
		},
		{
			 ...
			 example: '<kbd>// create instance of Cardiovascular</kbd>\n<var>var</var> mycardio = Cardiovascular("male", datetime.datetime(1990,3,17), 54, 154)'+
			 '\n\n<kbd>// call method from instance of Cardiovascular</kbd>\nmycardio.get_age() <kbd>24.96</kbd>',
			 methods: [{
				 name: "get_age",
				 arguments: [],
				 val: "years",
				 ...
				 equations: [],
				 example: '<kbd>// create instance of Cardiovascular</kbd>\n<var>var</var> mycardio = Cardiovascular("male", datetime.datetime(1990,3,17), 54, 154)'+
				 '\n\n<kbd>// call get_age from instance of Cardiovascular</kbd>\nmycardio.get_age() <kbd>24.96</kbd>',
			 },
			 {
				 name: "fatFreeMass",
				 arguments: [{
			...
			},
			{
				 ...
				 example: '<kbd>// create instance of Muscle</kbd>\n<var>var</var> muscles = Muscle("male", datetime.datetime(1990,3,17), 54, 154)'+
				 '\n\n<kbd>// call methods from Muscle</kbd>\nmuscles.get_age() <kbd>24.96</kbd>'+
				 '\nme.muscles.get_age() <kbd>24.96</kbd>',
				 methods: [{
					 name: "get_age",
					 arguments: [],
					 val: "years",
					 ...
					 equations: [],
					 example: '<kbd>// create instance of Muscle</kbd>\n<var>var</var> muscles = Muscle("male", datetime.datetime(1990,3,17), 54, 154)'+
					 '\n\n<kbd>// call get_age from Muscle</kbd>\nmuscles.get_age() <kbd>24.96</kbd>',
				 },
				 {
				 ...
				 },
				 {
					 ...
					 example: '<kbd>// create instance of Muscle</kbd>\n<var>var</var> muscles = Muscle("female", datetime.datetime(1990,3,17), 54, 154)'+
