...
{
    "distutils": {
        "name": "pyfit.sport.running.adjustment", 
        "sources": [
...
extern int __pyx_module_is_main_pyfit__sport__running__adjustment;
...
static const char __pyx_k_farenheit[] = "farenheit";
...
static PyObject *__pyx_n_s_farenheit;
...
static PyObject *__pyx_float_1_0075;
static PyObject *__pyx_float_1_0225;
static PyObject *__pyx_float_1_0375;
 ...
 */
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_s_60, __pyx_int_1) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_s_65, __pyx_float_1_0075) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_s_70, __pyx_float_1_015) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_s_75, __pyx_float_1_0225) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_s_80, __pyx_float_1_03) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_s_85, __pyx_float_1_0375) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_s_90, __pyx_float_1_045) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_s_95, __pyx_float_1_0525) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_s_100, __pyx_float_1_06) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
 ...
 */
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_seconds); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_seconds); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyDict_GetItem(__pyx_v_factors, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 13, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_WriteUnraisable("pyfit.sport.running.adjustment.temperature", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pw_5pyfit_5sport_7running_10adjustment_1temperature(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_seconds,&__pyx_n_s_farenheit,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_seconds)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_farenheit)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("temperature", 1, 2, 2, 1); __PYX_ERR(0, 1, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "temperature") < 0)) __PYX_ERR(0, 1, __pyx_L3_error)
      }
    ...
    __pyx_v_farenheit = __Pyx_PyObject_AsWritableString(values[1]); if (unlikely((!__pyx_v_farenheit) && PyErr_Occurred())) __PYX_ERR(0, 1, __pyx_L3_error)
  }
...
static int __pyx_pymod_exec_adjustment(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_adjustment},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_farenheit, __pyx_k_farenheit, sizeof(__pyx_k_farenheit), 0, 0, 1, 1},
...
static int __Pyx_InitGlobals(void) {
  ...
  __pyx_float_1_0075 = PyFloat_FromDouble(1.0075); if (unlikely(!__pyx_float_1_0075)) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_float_1_0225 = PyFloat_FromDouble(1.0225); if (unlikely(!__pyx_float_1_0225)) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_float_1_0375 = PyFloat_FromDouble(1.0375); if (unlikely(!__pyx_float_1_0375)) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_float_1_0525 = PyFloat_FromDouble(1.0525); if (unlikely(!__pyx_float_1_0525)) __PYX_ERR(0, 1, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initadjustment(void); /*proto*/
PyMODINIT_FUNC initadjustment(void)
#else
PyMODINIT_FUNC PyInit_adjustment(void); /*proto*/
PyMODINIT_FUNC PyInit_adjustment(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_adjustment(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_adjustment(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("adjustment", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyfit.sport.running.adjustment", 0, __pyx_lineno, __pyx_filename);
    }
